        ...
        {!creating ? (
          <div className="mt-8 flex flex-col gap-3">
            ...
            <button
              ...
              className="rounded-lg border border-zinc-700 px-4 py-2.5 font-medium text-zinc-200 hover:bg-zinc-800"
            >
                  ...
                  {recents.map((dir) => (
                    <li key={dir}>
                      <button
                        ...
                        className="w-full truncate rounded px-2 py-1.5 text-left text-sm text-zinc-300 hover:bg-zinc-800"
                        title={dir}
                      >
                        {dir.split('/').at(-1)}
          ...
          <div className="mt-8 flex flex-col gap-3">
            <label className="flex flex-col gap-1 text-sm text-zinc-400">
              ...
              <input
                ...
                className="rounded-lg border border-zinc-700 bg-zinc-900 px-3 py-2 text-zinc-100 outline-none focus:border-indigo-500"
            ...
            <label className="flex flex-col gap-1 text-sm text-zinc-400">
              Series <span className="text-zinc-600">(optional — creates a series folder)</span>
              <input
                value={seriesTitle}
            ...
            <div className="mt-2 flex gap-2">
              ...
              <button
                ...
                className="rounded-lg border border-zinc-700 px-4 py-2.5 text-zinc-300 hover:bg-zinc-800"
              >
                Back
              </button>
            </div>
